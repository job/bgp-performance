...
class OpenBGP85(Container):
    CONTAINER_NAME = None
    GUEST_DIR = '/root/config'

    def __init__(self, host_dir, conf, image='bgperf/openbgp85'):
        super(OpenBGP85, self).__init__(self.CONTAINER_NAME, image, host_dir, self.GUEST_DIR, conf)

    @classmethod
    def build_image(cls, force=False, tag='bgperf/openbgp85', checkout='', nocache=False):
...
class OpenBGPTarget85(OpenBGP85, Target):
    ...
    CONTAINER_NAME = 'bgperf_openbgp85_target'
